...
if ( win_w > 1400 ){
	...
	$("#section1").on("DOMMouseScroll mousewheel wheel", function(event,delta){
		...
		if (delta > 0) {
			if($('.main_wrap').hasClass('end') == true){
				...
				$('.main_wrap').removeClass('on3 end3 on end hide').addClass('on2');
				setTimeout(function() {
	...
	$("#section6").on("DOMMouseScroll mousewheel wheel", function(event,delta){
		...
		if (delta > 0) {
			...
			} else if($('.brand_wrap').hasClass('end3') == true){
				$('.brand_wrap').removeClass('on3 end3').addClass('on2');
				setTimeout(function() {
					$('.brand_wrap').addClass('end2');
				}, 1600);
			} else if($('.brand_wrap').hasClass('end4') == true){
				$('.brand_wrap').removeClass('on4 end4').addClass('on3');
				setTimeout(function() {
					$('.brand_wrap').addClass('end3');
				}, 1600);
			}
		} else if (delta < 0) {
			if($('.brand_wrap').hasClass('end4') == true){
				...
				$('.brand_wrap').removeClass('on end on2 end2').addClass('on3');
				setTimeout(function() {
					$('.brand_wrap').addClass('end3');
				}, 1600);
			} else if($('.brand_wrap').hasClass('end3') == true){
				$('.brand_wrap').removeClass('on3 end3').addClass('on4');
				setTimeout(function() {
					$('.brand_wrap').addClass('end4');
				}, 1600);
			}
		}
	});
	...
	$('#fullpage').fullpage({
	  ...
	  onLeave: function(index, nextIndex, direction){
		...
		if (index === 6 && direction === 'up'){
		  $('.brand_wrap').removeClass('end on4 end4 on3 end3 on2 end2');
		  setTimeout(() => { $('.brand_wrap').removeClass('on'); }, TRANSITION);
	
		  $('.unit_wrap').addClass('on');
		  setTimeout(() => { $('.unit_wrap').addClass('end'); }, TRANSITION);
		} else if (index === 6 && direction === 'down'){
		  $('.brand_wrap').removeClass('on end on2 end2 on3 end3');
		  setTimeout(() => { $('.brand_wrap').removeClass('on'); }, TRANSITION);
		...
		if (index === 7 && direction === 'up'){
		  ...
		  $('.brand_wrap').addClass('on4');
		  setTimeout(() => { $('.brand_wrap').addClass('end4'); }, TRANSITION);
	...
	$(document).on('click', '.menu7', function(){
	  ...
	  setTimeout(() => {
		...
		$('.main_wrap').removeClass('end2 on2').addClass('on2 end2');
		$('.location_wrap').removeClass('on2 end2 on3 end3').addClass('on3 end3');
		$('.brand_wrap').removeClass('on end end2 on2 on3 end3').addClass('on4 end4');
	  }, TRANSITION);
